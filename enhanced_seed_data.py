...
def create_stakeholders_with_meddpicc(companies):
    ...
    stakeholder_templates = [
        ...
        },
        {
            ...
            "email": "j.wilson@{domain}",
        },
        {
            "name": "Maria Gonzalez",
            "job_title": "Chief Financial Officer",
            "email": "m.gonzalez@{domain}",
        },
        {
            "name": "Kevin O'Connor",
            "job_title": "Head of Procurement",
            "email": "k.oconnor@{domain}",
        },
        {
            "name": "Nicole Smith",
            "job_title": "Senior Manager",
            "email": "n.smith@{domain}",
        },
        {
            "name": "Ryan Murphy",
            "job_title": "Technical Lead",
            "email": "r.murphy@{domain}",
        },
        {
            "name": "Alex Cooper",
            "job_title": "VP of Engineering",
            "email": "a.cooper@{domain}",
        },
        {
            "name": "Diana Foster",
            "job_title": "Operations Manager",
            "email": "d.foster@{domain}",
        },
        {
            "name": "Tom Bradley",
            "job_title": "IT Manager",
            "email": "t.bradley@{domain}",
        },
    ]
    ...
    for i, company in enumerate(companies):
        ...
        domain = (
            ...
            if company.website
            else f"{company.name.lower().replace(' ', '')}.com"
        )
        ...
        for template in company_stakeholders:
            ...
            meddpicc_roles = job_title_meddpicc_mapping.get(
                template["job_title"], ["user"]
            )
            ...
            print(
                f"  ✅ Created {stakeholder.name} ({stakeholder.job_title}) with roles: {', '.join(meddpicc_roles)}"
            )
...
def assign_account_teams(users, companies):
    ...
    for company in companies:
        ...
        for user in assigned_users:
            assignment = CompanyAccountTeam(user_id=user.id, company_id=company.id)
    ...
    for company in companies:
        ...
        for i in range(num_opps):
            ...
            company_stakeholders = [
                s for s in stakeholders if s.company_id == company.id
            ]
            num_stakeholder_assignments = random.randint(1, len(company_stakeholders))
            assigned_stakeholders = random.sample(
                company_stakeholders, num_stakeholder_assignments
            )
            ...
            print(
                f"  ✅ Created {opportunity.name} with {len(assigned_stakeholders)} stakeholders"
            )
...
def main():
    ...
    print(
        "🌱 Starting enhanced CRM data seeding with single source of truth architecture"
    )
    ...
    print("   - Account team assignments with inheritance")
    print("   - Stakeholder relationship ownership mapping")
    print("   - Multi-entity task linking")
