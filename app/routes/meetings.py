...
def index():
    ...
    return render_template(
        "meetings/index.html", meetings=meetings, companies=companies
    )
...
def new():
    ...
    if request.method == "POST":
        ...
        if request.is_json:
            ...
            flash(
                "Meeting created successfully. Analysis will begin shortly.", "success"
            )
...
def detail(meeting_id):
    ...
    return render_template(
        "meetings/detail.html", meeting=meeting, insights=organized_insights
    )
