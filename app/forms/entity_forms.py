...
from wtforms import StringField, TextAreaField, SelectField, DecimalField, DateField, IntegerField
...
class CompanyForm(FlaskForm):
    ...
    website = StringField(
        'Website',
        validators=[Optional(), URL(message='Please enter a valid URL'), Length(max=255)],
