...
from app.models import db, Company, Contact, Opportunity, Task
...
def create_sample_tasks_with_multi_entity_linking():
    ...
    for i in range(20):
        ...
        print(
            f"✅ Created task: {task.description[:30]}... with {len(linked_entities)} entity links"
        )

    db.session.commit()
    print("✅ Created 20 multi-entity linked tasks")
