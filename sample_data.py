...
def create_sample_data():
    ...
    with app.app_context():
        ...
        companies = [
            Company(name="TechCorp Solutions", industry="Technology", website="https://techcorp.example.com"),
            Company(name="GreenEnergy Inc", industry="Renewable Energy", website="https://greenenergy.example.com"),
            Company(name="DataFlow Systems", industry="Data Analytics", website="https://dataflow.example.com"),
            Company(name="CloudFirst Technologies", industry="Cloud Computing"),
            Company(name="FinanceMax Ltd", industry="Financial Services", website="https://financemax.example.com")
        ]
        ...
        contacts = [
            Contact(name="John Smith", role="CEO", email="john.smith@techcorp.example.com", phone="+1-555-0101", company_id=1),
            Contact(name="Sarah Johnson", role="CTO", email="sarah.johnson@techcorp.example.com", phone="+1-555-0102", company_id=1),
            Contact(name="Mike Chen", role="VP Sales", email="mike.chen@greenenergy.example.com", phone="+1-555-0201", company_id=2),
            Contact(name="Lisa Rodriguez", role="Product Manager", email="lisa.rodriguez@dataflow.example.com", phone="+1-555-0301", company_id=3),
            Contact(name="David Kim", role="Engineering Lead", email="david.kim@cloudfirst.example.com", company_id=4),
            Contact(name="Emma Wilson", role="CFO", email="emma.wilson@financemax.example.com", phone="+1-555-0501", company_id=5)
        ]
        ...
        opportunities[0].contacts.extend([contacts[0], contacts[1]])  # TechCorp opp with John & Sarah
