...
MEETING_EXTRACTION_SCHEMA = {
    "type": "object",
    "required": ["attendees", "technologies_mentioned", "action_items", "key_decisions", "sentiment_analysis", "topics_discussed", "summary"],
    "properties": {
        "attendees": {
            "type": "array",
            "items": {
...
class ExtractionValidator:
    ...
    def __init__(self):
        self.schemas = {
            "meeting": MEETING_EXTRACTION_SCHEMA
        }
    ...
    def validate_meeting_extraction(self, data: Dict[str, Any]) -> ValidationResult:
        ...
        try:
            ...
            required_fields = ["attendees", "technologies_mentioned", "action_items", 
            ...
            for i, attendee in enumerate(attendees):
                if isinstance(attendee, dict) and attendee.get("name"):
                    clean_attendee = {
                        ...
                        "sentiment": self._validate_sentiment(attendee.get("sentiment"))
                    }
            ...
            cleaned_data["technologies_mentioned"] = [
                str(tech).strip() for tech in technologies 
            ...
            cleaned_data["key_decisions"] = [
                str(decision).strip() for decision in decisions
            ...
            cleaned_data["sentiment_analysis"] = {
                ...
                "concerns": [
                    str(concern).strip() for concern in sentiment.get("concerns", [])
            ...
            cleaned_data["topics_discussed"] = [
                str(topic).strip() for topic in topics
